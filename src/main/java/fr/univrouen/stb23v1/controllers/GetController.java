...
public class GetController {
    ...
    @GetMapping("/stbid")
    public String getRSSinXML(@RequestParam(value = "id") String text) {
        return ("Détail de la STB n°" + text);
    }

    @GetMapping("/test")
    public String getRSSinXML(@RequestParam(value = "id") String id, @RequestParam(value = "titre") String titre) {
